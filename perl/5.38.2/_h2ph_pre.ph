...
unless (defined &_FORTIFY_SOURCE) { sub _FORTIFY_SOURCE() { 3 } }
...
unless (defined &__BFLT16_DECIMAL_DIG__) { sub __BFLT16_DECIMAL_DIG__() { 4 } }

unless (defined &__BFLT16_DENORM_MIN__) { sub __BFLT16_DENORM_MIN__() { "9\.18354961579912115600575419704879436e\-41BF16" } }

unless (defined &__BFLT16_DIG__) { sub __BFLT16_DIG__() { 2 } }

unless (defined &__BFLT16_EPSILON__) { sub __BFLT16_EPSILON__() { "7\.81250000000000000000000000000000000e\-3BF16" } }

unless (defined &__BFLT16_HAS_DENORM__) { sub __BFLT16_HAS_DENORM__() { 1 } }

unless (defined &__BFLT16_HAS_INFINITY__) { sub __BFLT16_HAS_INFINITY__() { 1 } }

unless (defined &__BFLT16_HAS_QUIET_NAN__) { sub __BFLT16_HAS_QUIET_NAN__() { 1 } }

unless (defined &__BFLT16_IS_IEC_60559__) { sub __BFLT16_IS_IEC_60559__() { 0 } }

unless (defined &__BFLT16_MANT_DIG__) { sub __BFLT16_MANT_DIG__() { 8 } }

unless (defined &__BFLT16_MAX_10_EXP__) { sub __BFLT16_MAX_10_EXP__() { 38 } }

unless (defined &__BFLT16_MAX_EXP__) { sub __BFLT16_MAX_EXP__() { 128 } }

unless (defined &__BFLT16_MAX__) { sub __BFLT16_MAX__() { "3\.38953138925153547590470800371487867e\+38BF16" } }

unless (defined &__BFLT16_MIN_10_EXP__) { sub __BFLT16_MIN_10_EXP__() { -37 } }

unless (defined &__BFLT16_MIN_EXP__) { sub __BFLT16_MIN_EXP__() { -125 } }

unless (defined &__BFLT16_MIN__) { sub __BFLT16_MIN__() { "1\.17549435082228750796873653722224568e\-38BF16" } }

unless (defined &__BFLT16_NORM_MAX__) { sub __BFLT16_NORM_MAX__() { "3\.38953138925153547590470800371487867e\+38BF16" } }
...
unless (defined &__DBL_IS_IEC_60559__) { sub __DBL_IS_IEC_60559__() { 1 } }
...
unless (defined &__FLT128_IS_IEC_60559__) { sub __FLT128_IS_IEC_60559__() { 1 } }
...
unless (defined &__FLT16_IS_IEC_60559__) { sub __FLT16_IS_IEC_60559__() { 1 } }
...
unless (defined &__FLT32X_IS_IEC_60559__) { sub __FLT32X_IS_IEC_60559__() { 1 } }
...
unless (defined &__FLT32_IS_IEC_60559__) { sub __FLT32_IS_IEC_60559__() { 1 } }
...
unless (defined &__FLT64X_IS_IEC_60559__) { sub __FLT64X_IS_IEC_60559__() { 1 } }
...
unless (defined &__FLT64_IS_IEC_60559__) { sub __FLT64_IS_IEC_60559__() { 1 } }
...
unless (defined &__FLT_IS_IEC_60559__) { sub __FLT_IS_IEC_60559__() { 1 } }
...
unless (defined &__GLIBC_MINOR__) { sub __GLIBC_MINOR__() { 39 } }
...
unless (defined &__GNUC__) { sub __GNUC__() { 13 } }

unless (defined &__GNU_LIBRARY__) { sub __GNU_LIBRARY__() { 6 } }

unless (defined &__GXX_ABI_VERSION) { sub __GXX_ABI_VERSION() { 1018 } }
...
unless (defined &__LDBL_IS_IEC_60559__) { sub __LDBL_IS_IEC_60559__() { 1 } }
...
unless (defined &__VERSION__) { sub __VERSION__() { "\"13\.2\.0\"" } }
